...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Scrape Intellicar vehicle records every 10 minutes.")
...
def main() -> None:
    ...
    while True:
        ...
        try:
            ...
            logging.info("Cycle complete. Appended %s Intellicar records.", len(records))
        except Exception:
            logging.exception("Intellicar scrape cycle failed")
